          ...
          <div className="h-screen flex items-center justify-center p-8">
            <div className="max-w-4xl w-full bg-zinc-950 border-4 border-[#7c3aed] rounded-3xl p-12">
              ...
              <div className="grid grid-cols-4 gap-3 mb-4">
                <button onClick={() => window.open('https://www.youtube.com/upload','_blank')} className="bg-red-600 py-4 rounded-xl font-black uppercase hover:bg-red-700 transition flex flex-col items-center gap-1 text-sm">▶️<span>YouTube</span></button>
                <button onClick={() => window.open('https://www.facebook.com/sharer/sharer.php?u='+encodeURIComponent(window.location.href),'_blank')} className="bg-blue-600 py-4 rounded-xl font-black uppercase hover:bg-blue-700 transition flex flex-col items-center gap-1 text-sm">👤<span>Facebook</span></button>
                <button onClick={() => window.open('https://twitter.com/intent/tweet?text='+encodeURIComponent('Check out my movie made with MandaStrong Studio! 🎬'),'_blank')} className="bg-sky-500 py-4 rounded-xl font-black uppercase hover:bg-sky-600 transition flex flex-col items-center gap-1 text-sm">🐦<span>Twitter/X</span></button>
                <button onClick={() => window.open('https://www.instagram.com','_blank')} className="bg-pink-600 py-4 rounded-xl font-black uppercase hover:bg-pink-700 transition flex flex-col items-center gap-1 text-sm">📸<span>Instagram</span></button>
              </div>
              <button 
                onClick={() => setPage(20)}
                disabled={!currentVideo}
